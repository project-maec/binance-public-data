      ...
      for year in years:
        for month in months:
          ...
          if current_date >= start_date and current_date <= end_date:
            ...
            if checksum == 1:
              checksum_path = "data/futures/um/monthly/klines/{}/{}/".format(symbol.upper(), interval)
  ...
  for symbol in symbols:
    ...
    for interval in intervals:
      for date in dates:
        ...
        if current_date >= start_date and current_date <= end_date:
          path = "data/futures/um/daily/klines/{}/{}/".format(symbol.upper(), interval)
          file_name = "{}-{}-{}.zip".format(symbol.upper(), interval, date)
          download_file(path, file_name, date_range, folder)

          if checksum == 1:
            checksum_path = "data/futures/um/daily/klines/{}/{}/".format(symbol.upper(), interval)
